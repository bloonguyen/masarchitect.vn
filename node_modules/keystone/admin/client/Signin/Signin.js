		...
		xhr({
			...
			if (err || body && body.error) {
				return body.error === 'invalid csrf'
					? this.displayError('Có lỗi xảy ra! Hãy thử tải lại trang web hoặc liên lạc với nhà phát triển') // <<< TIẾNG VIỆT
					: this.displayError('Thông tin đăng nhập của bạn không chính xác. Hãy thử lại!');  //<<< TIẾNG VIỆT
			} else {
		...
		return (
			<div className="auth-wrapper">
				...
				<div className="auth-footer">
					...
					<a href="http://gamarist.com" target="_blank" title="The Node.js CMS and web application platform (new window)">Gamarist Studio</a>
				</div>
			</div>
		);
	},
