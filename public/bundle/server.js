...
exports.FooterBar = exports.HeaderBarMobile = exports.HeaderBarDesktop = exports.HeaderBar = undefined;
	...
	_createClass(HeaderBar, [{
		...
		value: function _renderNavBar() {
			...
			if (!this.state.mobileMode) {
				//desktop view
				return _react2.default.createElement(HeaderBarDesktop, {
					switchLang: this.props.switchLang,
					locale: this.props.locale,
					mode: "desktop",
				...
				if (!this.state.navBarDropDown) {
					...
					return _react2.default.createElement(
						...
						_react2.default.createElement(HeaderBarMobile, {
							mode: "mobile",
							lang: this.props.lang,
							switchLang: this.props.switchLang,
							locale: this.props.locale })
...
var HeaderBarDesktop = exports.HeaderBarDesktop = function (_React$Component3) {
	_inherits(HeaderBarDesktop, _React$Component3);

	function HeaderBarDesktop() {
		_classCallCheck(this, HeaderBarDesktop);

		return _possibleConstructorReturn(this, (HeaderBarDesktop.__proto__ || Object.getPrototypeOf(HeaderBarDesktop)).apply(this, arguments));
	}

	_createClass(HeaderBarDesktop, [{
		key: 'switchLang',
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'ul',
				{ className: _main_style2.default.nav_bar_container },
				_react2.default.createElement(
					'li',
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('img', { style: { height: '20px', margin: '0 -5px' }, src: '/images/icon/social_insta.png' })
					)
				),
				_react2.default.createElement(
					'li',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('img', { style: { height: '20px', margin: '0 -5px' }, src: '/images/icon/social_fb.png' })
					)
				)
			);
		}
...
var HeaderBarMobile = exports.HeaderBarMobile = function (_React$Component4) {
	_inherits(HeaderBarMobile, _React$Component4);

	function HeaderBarMobile() {
		_classCallCheck(this, HeaderBarMobile);

		return _possibleConstructorReturn(this, (HeaderBarMobile.__proto__ || Object.getPrototypeOf(HeaderBarMobile)).apply(this, arguments));
	}

	_createClass(HeaderBarMobile, [{
		key: 'switchLang',
		value: function switchLang() {
			if (this.props.locale == 'vi') {
				console.log('header bar items: ', this.props);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'ul',
				{ className: _main_style2.default.expanded_container },
				_react2.default.createElement(
					'li',
					{ className: _main_style2.default.nav_item },
					_react2.default.createElement(
...
var FooterBar = exports.FooterBar = function (_React$Component5) {
			...
			switch (this.props.item) {
				...
				case "profile":
					nodeList = this.props.data.map(function (item, index) {
						...
						return _react2.default.createElement(
							_reactRouter.Link,
							{ to: "/ourteam/" + item.key, style: { textDecoration: 'none' } },
							_react2.default.createElement(
								'li',
								{ className: _itemGrid_style2.default.item_container,
									key: index },
				...
				case "press":
					nodeList = this.props.data.map(function (item, index) {
						var url = item.hinhDaiDien ? (0, _utils.cloudinaryModify)(item.hinhDaiDien.url, 'w_512') : "/images/img_holder.jpg";
						if (item.kieu == "press") {
							return _react2.default.createElement(
								'li',
								{ className: _itemGrid_style2.default.item_container,
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ className: _blog_style2.default.text_board },
									_react2.default.createElement(
										'div',
										null,
										_react2.default.createElement(
											'div',
											{ style: { fontWeight: '500', marginBottom: '10px', textTransform: 'uppercase' } },
										...
										_react2.default.createElement(
											...
											null,
											' ',
											this.props.data.noiDung.tomTat
										)
									),
									_react2.default.createElement(
										'p',
...
exports = module.exports = _react2.default.createElement(
	_reactRouter.Router,
	{ history: _reactRouter.browserHistory },
	_react2.default.createElement(_reactRouter.Route, { path: '/', component: _index2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/about', component: _about2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/about/:type', component: _about2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/ourteam/:key', component: _staffCV2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/blog', component: _blog2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/post/:key', component: _post2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/project_category/:name', component: _projectCategory2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/project_category', component: _projectCategory2.default }),
	_react2.default.createElement(_reactRouter.Route, { path: '/project/:name', component: _project2.default }),
    ...
    _createClass(General, [{
        ...
        value: function fetchDataFromServer() {
            ...
            fetch('/api/about', {
                ...
                _this2.setState({ name: responseJson });
                console.log('fetch data result: ', _this2.state.name);
            });
        }
    }, {
        key: 'componentWillReceiveProps',
        ...
        value: function render() {
            ...
            var nodeList = this.state.name.map(function (item, index) {
                if (_this3.props.locale == item.ngonNgu) return _react2.default.createElement(
                    'div',
                    { className: _about_style2.default.wrapper },
                    _react2.default.createElement('div', { className: _about_style2.default.intro_para,
...
var _itemGrid = __webpack_require__(10);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: "/ourteam/" + person, style: { textDecoration: 'none	' } },
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement('div', { className: _itemGrid_style2.default.profile_item,
...
var _getData = __webpack_require__(13);
	...
	_createClass(Press, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_itemGrid2.default, { locale: this.props.locale, item: "press", data: this.state.blogData })
			);
		}
	}]);
...
var _navBarItem = __webpack_require__(12);
    ...
    _createClass(AboutPage, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: _globalStyles2.default.content_board },
                    this._renderAbout()
                )
            );
        }
    ...
    _createClass(ContactPage, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { style: { marginBottom: '20px' }, className: _globalStyles2.default.breadscrumb },
                    _react2.default.createElement(
                        _reactRouter.Link,
                        { to: '/contact' },
	...
	_createClass(Post, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: _blog_style2.default.content_wrapper, style: { display: 'initial' } },
					_react2.default.createElement(
						'div',
						{ className: _blog_style2.default.content_left_wrapper },
						_react2.default.createElement(
							'div',
							{ className: _blog_style2.default.title, style: { textTransform: 'uppercase' } },
							this.props.data.tieuDe
						),
						_react2.default.createElement(
							'p',
					...
					_react2.default.createElement(
						...
						{ className: _blog_style2.default.content_right },
						youtubeEmbeded,
						_react2.default.createElement('p', { className: _blog_style2.default.title, style: { fontSize: '13px', fontWeight: '300' },
	...
	_createClass(ProjectPage, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(ProjectUnit, { locale: this.props.locale, data: this.state.project })
			);
		}
	}]);
	...
	_createClass(ProjectUnit, [{
		...
		value: function _renderVrImage() {
			if (this.props.data.vrImage) {
				var url = this.props.data.vrThumbnail ? (0, _utils.cloudinaryModify)(this.props.data.vrThumbnail.url, 'w_512') : '/images/img_holder.jpg';
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(
...
var StaffCV = function (_React$Component) {
    _inherits(StaffCV, _React$Component);

    function StaffCV(props) {
        _classCallCheck(this, StaffCV);

        var _this = _possibleConstructorReturn(this, (StaffCV.__proto__ || Object.getPrototypeOf(StaffCV)).call(this, props));
    ...
    _createClass(StaffCV, [{
        key: 'fetchCVFromServer',
        value: function fetchCVFromServer() {
            var _this2 = this;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: _blog_style2.default.content_right },
                            _react2.default.createElement('img', { src: anhDaiDien })
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: giaithich } })
                                )
                            )
                        )
                    )
...
exports = module.exports = function (req, res) {
   ...
   (0, _reactRouter.match)({ routes: _routes2.default.props.children, location: req.url }, function (err, redirect, props) {
...
// module
exports.push([module.i, ".client-layout-styles-___about_style__title___u9A5M{\n    font-weight: bold;\n    font-size: 14px;\n}\n\n.client-layout-styles-___about_style__para_wrapper___fHSH5{\n    padding:20px;\n}\n.client-layout-styles-___about_style__para___n6M0u{\n    font-size: 13px;\n    line-height: 1.5em;\n}\n\n.client-layout-styles-___about_style__wrapper___1EC3u{\n    text-align: justify;\n    letter-spacing: 0.01px;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\n/*@media (max-width: 700px) {\n  .wrapper {\n      flex-direction: column;\n  }\n}\n\n@media (min-width: 700px) {\n  .wrapper {\n      flex-direction: row;\n  }\n}*/\n\n.client-layout-styles-___about_style__carousel_img___1b-4K {\n\twidth:  100vw;\n    max-width: 800px;\n\tobject-fit: cover;\n    height: auto;\n}\n\n.client-layout-styles-___about_style__intro_para___35HcW{\n    margin-left: auto;\n    margin-right: auto;\n    max-width: 700px;\n    width: 80vw;\n}\n\n.client-layout-styles-___about_style__intro_para___35HcW img {\n    width: 100%!important;\n}\n\n.client-layout-styles-___about_style__cover_container___toM3P {\n\tposition: relative;\n    max-width: 800px;\n    width:  100vw;\n    height: 65vw;\n    max-height: 520px;\n    /*margin-left: auto;\n    margin-right: auto;*/\n\t/*display: flex;*/\n\t/*justify-content: center;*/\n}\n\n.client-layout-styles-___about_style__cover_container___toM3P ul{\n    min-height: 65vw;\n    height: auto;\n    max-height: 520px;\n}\n\n@media only screen and (min-width:768px){\n    .client-layout-styles-___about_style__cover_container___toM3P ul{\n        min-height: 520px;\n    }\n}\n", ""]);
...
exports.locals = {
	...
	"carousel_img": "client-layout-styles-___about_style__carousel_img___1b-4K",
	"intro_para": "client-layout-styles-___about_style__intro_para___35HcW",
	"cover_container": "client-layout-styles-___about_style__cover_container___toM3P"
};
...
exports.locals = {
	...
	"text_board": "client-layout-styles-___blog_style__text_board___3NC_p"
};
...
exports.locals = {
	...
	"expanded_nav_bar": "client-layout-styles-___main_style__expanded_nav_bar___3mUJ0",
